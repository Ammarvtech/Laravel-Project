            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item active">
                        <p class="nav-link" style="color: black;">Info@gmail.com</p>
                    </li>
                    <li class="nav-item active">
                        <p class="nav-link" style="color: black;">+923041705101</p>
                    </li>
                    <li class="nav-item active">
                ...
                <div class="container">
                    <div class="copyright-footer">
                        <div class="columns text-lg-left">
                            <p>&copy; 2020 Laravel . All rights reserved | Designed by <a
                                    href="{{url('/')}}">Ammar</a></p>
                        </div>
